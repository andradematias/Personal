//this function contains ajax call to node.js webservice called WsVerifyUnique
var ProcessFunction = function () {
    ...
    var requestObject = $.ajax({
        type: "POST",
        url: VV.BaseAppUrl + 'api/v1/' + VV.CustomerAlias + '/' + VV.CustomerDatabaseAlias + '/scripts?name=WsVerifyUnique',
        ...
        if (resp.data[0] != 'undefined') {
            ...
            if (resp.data[0] == 'Success') {
                VV.Form.DoAjaxFormSave().then(function () {
                    VV.Form.Global.DisplayMessaging("File Upload Form was saved.", "File Upload Form");
                    VV.Form.HideLoadingPanel();
                });
            }

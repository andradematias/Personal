  ...
  ​
    ...
    **********/
    ...
    try {
        ...
        let billIDOrder = getFieldValueByName('Bill Id');

        // 1° Checks if the required paramenters are present.

        // Checks if the required paramenters are present
        if (!OrderRecordID || !dish || !amount || !price || !billIDOrder) {
        ...
        const formTemplateName = "Bill"; // This could be placed in the Config Variables section
        const formGUID = billIDOrder;

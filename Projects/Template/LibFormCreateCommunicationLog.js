    ...
    */
    ...
    try {
        ...
        if (!relateToRecord || !relateToRecord.value) {
            inputErrors++;
            inputErrorsMessage += 'The RELATETORECORD parameter was not supplied. This should be an array of Form IDs to which the communication log should be related. <br>';
        }
